...
class TestTokenLimitParams:
    def test_gpt5_uses_max_completion_tokens(self):
        assert _token_limit_param_for_model("gpt-5.5", 4096) == {"max_completion_tokens": 4096}
...
def test_openai_client_init_normalizes_base_url(monkeypatch):
    ...
    monkeypatch.setattr("myharness.api.openai_client.AsyncOpenAI", _StubAsyncOpenAI)
