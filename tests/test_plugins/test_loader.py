...
from myharness.hooks.loader import load_hook_registry
from myharness.plugins import load_plugins
from myharness.plugins.loader import get_user_plugins_dir
...
def test_user_plugins_still_load_when_project_plugins_are_disabled(tmp_path: Path, monkeypatch):
    monkeypatch.setenv("MYHARNESS_CONFIG_DIR", str(tmp_path / "config"))
    project = tmp_path / "repo"
    project_plugins_root = project / ".myharness" / "plugins"
