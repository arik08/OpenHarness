...
# Doing tasks
 ...
 - Default report chart palette: prefer #3288bd, #66c2a5, #e6f598, #d53e4f as common first choices, then choose from #9e0142, #f46d43, #fdae61, #fee08b, #abdda4, #5e4fa2 as context requires. These first choices are not mandatory; use judgment for semantics, contrast, and series count, but avoid dull default chart palettes.
