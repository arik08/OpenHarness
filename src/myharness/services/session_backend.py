...
from myharness.services import session_storage
...
class MyHarnessSessionBackend:
    """Default session backend backed by ``<project>/.myharness/sessions``."""
...
DEFAULT_SESSION_BACKEND: SessionBackend = MyHarnessSessionBackend()
