...
(function() {
  ...
  class DeckStage extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // ： script  <head> （ </deck-stage> ），
      // parser  <section>，querySelectorAll 。
      // ， parse 。
      const init = () => {
        this._collectSlides();
