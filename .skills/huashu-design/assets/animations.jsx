 ...
 *
 * Exports on window.Animations:
 * - Stage: whole animation container with time and controls
 * - Sprite: time segment shown between start/end with local progress
 * - useTime(): read global time in seconds
 ...
 *   </Stage>
 *
 * Use useSprite() inside Sprite children to read current segment progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // expoOut: Anthropic-level  easing (cubic-bezier(0.16, 1, 0.3, 1))
    // Fast start and slow braking for physical weight.
    expoOut: t => t === 1 ? 1 : 1 - Math.pow(2, -10 * t),
    // overshoot: Elastic toggle and button pop. (cubic-bezier(0.34, 1.56, 0.64, 1))
    overshoot: t => {
